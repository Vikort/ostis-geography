...
trash_js_path=components/js/trash/trash.js
trash_css_path=components/css/trash.css
...
append_js $sc_web_path/templates/components.html $trash_js_path
append_css $sc_web_path/templates/components.html $trash_css_path
