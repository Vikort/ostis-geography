...
cinema_js_path=components/js/cinema/cinema.js
cinema_css_path=components/css/cinema.css
...
append_js $sc_web_path/templates/components.html $cinema_js_path
append_css $sc_web_path/templates/components.html $cinema_css_path