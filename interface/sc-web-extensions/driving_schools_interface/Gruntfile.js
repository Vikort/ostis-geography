module.exports = function(grunt) {
    ...
    var drivingScholsDirPath = 'components/driving_schools_ui/';
    ...
    grunt.initConfig({
        concat: {
            ...
            drivingSchoolsSection: {
                src: [drivingScholsDirPath + 'src/driving-schools-common.js',
                    drivingScholsDirPath + 'src/driving-schools-component.js',
                    drivingScholsDirPath + 'src/driving-schools-paintPanel.js'
                ],
                dest: drivingScholsDirPath + 'static/components/js/driving_schools_ui/driving-schools.js'
            },
        },
        copy: {
            githubJs: {
            ...
            drivingSchoolsJs: {
                cwd: drivingScholsDirPath + 'static/components/js/driving_schools_ui/',
                src: 'driving-schools.js',
                dest: clientJsDirPath + 'driving_schools_ui/',
                expand: true,
                flatten: true
            },
            githubCss: {
        ...
        watch: {
            ...
            drivingSchoolsJs: {
                files: drivingScholsDirPath + 'src/**',
                tasks: ['concat:drivingSchoolsSection', 'copy:drivingSchoolsJs'],
            },
            githubCss: {
