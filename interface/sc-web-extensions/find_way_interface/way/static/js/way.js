...
Way.PaintPanel.prototype = {
    ...
    _initMarkup: function (containerId) {
		...
		container.append('<label for="pn2" id="name-pn2">Название второй автовокзала</label>');
		container.append('<input id="pn2" type="text" class="form-control-plaintext" placeholder="Name for second bus station">');
		container.append('<label for="pd2" id="name-pd2">Название городавторого автовокзала</label>');
