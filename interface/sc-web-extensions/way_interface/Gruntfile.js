module.exports = function(grunt) {
    ...
    grunt.initConfig({
        concat: {
			...
			way: {
                src: [wayDirPath + 'src/way-common.js',
                    wayDirPath + 'src/way-component.js',
                    wayDirPath + 'src/way-paintPanel.js'
                ],
                dest: wayDirPath + 'static/components/js/way/way.js'
            },
            html: {
        ...
        copy: {
			...
			wayJs: {
                cwd: wayDirPath + 'static/components/js/way/',
                src: 'way.js',
