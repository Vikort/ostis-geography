...
append_js $sc_web_path/templates/components.html components/js/search_kindergartens_by_city_component/search_kindergartens_by_city_component.js
append_css $sc_web_path/templates/components.html components/css/search_kindergartens_by_city_component.css
