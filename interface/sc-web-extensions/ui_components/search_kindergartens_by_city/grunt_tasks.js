module.exports = function() {
    ...
    return  {
        concat: {
            search_kindergartens_by_city_component: {
                src: [
                    components + 'src/search_kindergartens_by_city_component.js'],
                dest: clientJsDirPath + 'search_kindergartens_by_city_component/search_kindergartens_by_city_component.js'
            }
        },
        copy: {
            search_kindergartens_by_city_component_IMG: {
                cwd: components + 'static/components/images/',
                src: ['*'],
                dest: clientImgDirPath + 'search_kindergartens_by_city_component/',
                expand: true,
                flatten: true
            },
            search_kindergartens_by_city_component_CSS: {
                cwd: components + 'static/components/css/',
                src: ['search_kindergartens_by_city_component.css'],
                dest: clientCssDirPath,
                expand: true,
                flatten: true
            },
            search_kindergartens_by_city_component_HTML: {
        ...
        watch: {
            search_kindergartens_by_city_component: {
                ...
                tasks: ['concat:search_kindergartens_by_city_component']
            },
            search_kindergartens_by_city_component_IMG: {
                files: [components + 'static/components/images/**'],
                tasks: ['copy:search_kindergartens_by_city_component_IMG']
            },
            search_kindergartens_by_city_component_CSS: {
                files: [components + 'static/components/css/**'],
                tasks: ['copy:search_kindergartens_by_city_component_CSS']
            },
            search_kindergartens_by_city_component_HTML: {
                files: [components + 'static/components/html/**',],
                tasks: ['copy:search_kindergartens_by_city_component_HTML']
            },
            copyKB: {
                files: [kb + '**',],
                tasks: ['copy:kb']
