...
append_js $sc_web_path/templates/components.html components/js/count_average_books_component/count_average_books_component.js
append_css $sc_web_path/templates/components.html components/css/count_average_books_component.css
