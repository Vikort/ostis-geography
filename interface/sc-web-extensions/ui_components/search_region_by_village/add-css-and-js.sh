...
append_js $sc_web_path/templates/components.html components/js/search_region_by_village_component/search_region_by_village_component.js
append_css $sc_web_path/templates/components.html components/css/search_region_by_village_component.css
