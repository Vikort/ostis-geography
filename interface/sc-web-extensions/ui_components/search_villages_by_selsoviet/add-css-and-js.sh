...
append_js $sc_web_path/templates/components.html components/js/search_villages_by_selsoviet_component/search_villages_by_selsoviet_component.js
append_css $sc_web_path/templates/components.html components/css/search_villages_by_selsoviet_component.css
