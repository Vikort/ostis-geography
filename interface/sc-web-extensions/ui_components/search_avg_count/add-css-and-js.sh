...
append_js $sc_web_path/templates/components.html components/js/search_coffee_houses/search_coffee_houses.js
append_css $sc_web_path/templates/components.html components/css/search_coffee_houses.css
