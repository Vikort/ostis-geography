module.exports = function() {
    ...
    var kb = 'kb/ui_components/search_villages_by_district_component';
    var components = 'sc-web/components/search_villages_by_district_component/';
    ...
    return  {
        concat: {
            search_villages_by_district_component: {
                src: [
                    components + 'src/search_villages_by_district_component.js'],
                dest: clientJsDirPath + 'search_villages_by_district_component/search_villages_by_district_component.js'
            }
        },
        copy: {
            search_villages_by_district_component_IMG: {
                ...
                src: ['*'],
                dest: clientImgDirPath + 'search_villages_by_district_component/',
                expand: true,
                flatten: true
            },
            search_villages_by_district_component_CSS: {
                cwd: components + 'static/components/css/',
                src: ['search_villages_by_district_component.css'],
            ...
            kb: {
                cwd: kb,
                src: ['*'],
                dest: '../../../../kb/ui_components/search_villages_by_district_component/',
                expand: true,
                flatten: true
            }
        },
        watch: {
            search_villages_by_district_component: {
                ...
                tasks: ['concat:search_villages_by_district_component']
            },
            search_villages_by_district_component_IMG: {
                files: [components + 'static/components/images/**'],
                tasks: ['copy:search_villages_by_district_component_IMG']
            },
            search_villages_by_district_component_CSS: {
                files: [components + 'static/components/css/**'],
                tasks: ['copy:search_villages_by_district_component_CSS']
            },
            search_villages_by_district_component_HTML: {
                files: [components + 'static/components/html/**',],
                tasks: ['copy:search_villages_by_district_component_HTML']
            },
            copyKB: {
                files: [kb + '**',],
                tasks: ['copy:kb']
