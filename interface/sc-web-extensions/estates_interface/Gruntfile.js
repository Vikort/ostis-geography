module.exports = function(grunt) {
    ...
    var drivingScholsDirPath = 'components/estates_ui/';
    ...
    grunt.initConfig({
        concat: {
            ...
            estatesSection: {
                src: [drivingScholsDirPath + 'src/estates-common.js',
                    drivingScholsDirPath + 'src/estates-component.js',
                    drivingScholsDirPath + 'src/estates-paintPanel.js'
                ],
                dest: drivingScholsDirPath + 'static/components/js/estates_ui/estates.js'
            },
        },
        copy: {
            githubJs: {
            ...
            estatesJs: {
                cwd: drivingScholsDirPath + 'static/components/js/estates_ui/',
                src: 'estates.js',
                dest: clientJsDirPath + 'estates_ui/',
                expand: true,
                flatten: true
            },
            githubCss: {
        ...
        watch: {
            ...
            estatesJs: {
                ...
                tasks: ['concat:estatesSection', 'copy:estatesJs'],
            },
            githubCss: {
