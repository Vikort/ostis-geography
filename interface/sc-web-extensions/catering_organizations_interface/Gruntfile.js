module.exports = function(grunt) {
    ...
    var cateringOrganizationsDirPath = 'components/catering_organizations_ui/';
    ...
    grunt.initConfig({
        concat: {
            ...
            cateringOrganizationsSection: {
                src: [cateringOrganizationsDirPath + 'src/catering-organizations-common.js',
                    cateringOrganizationsDirPath + 'src/catering-organizations-component.js',
                    cateringOrganizationsDirPath + 'src/catering-organizations-paintPanel.js'
                ],
                dest: cateringOrganizationsDirPath + 'static/components/js/catering_organizations_ui/catering-organizations.js'
            },
        },
        copy: {
            githubJs: {
            ...
            cateringOrganizationsJs: {
                cwd: cateringOrganizationsDirPath + 'static/components/js/catering_organizations_ui/',
                src: 'catering-organizations.js',
                dest: clientJsDirPath + 'catering_organizations_ui/',
                expand: true,
                flatten: true
            },
            githubCss: {
        ...
        watch: {
            ...
            cateringOrganizationsJs: {
                files: cateringOrganizationsDirPath + 'src/**',
                tasks: ['concat:cateringOrganizationsSection', 'copy:cateringOrganizationsJs'],
            },
            githubCss: {
