...
administration_js_path=components/js/administration/administration.js
administration_css_path=components/css/administration.css
...
append_js $sc_web_path/templates/components.html $administration_js_path
append_css $sc_web_path/templates/components.html $administration_css_path
