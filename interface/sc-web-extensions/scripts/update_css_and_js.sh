...
parks_js_path=components/js/parks/parks.js
parks_css_path=components/css/parks.css
...
append_js $sc_web_path/templates/components.html $parks_js_path
append_css $sc_web_path/templates/components.html $parks_css_path
