...
villages_js_path=components/js/villages/villages.js
villages_css_path=components/css/villages.css
...
append_js $sc_web_path/templates/components.html $villages_js_path
append_css $sc_web_path/templates/components.html $villages_css_path
