...
shop_translator_js_path=components/js/shop_translator/shop_translator.js
shop_translator_css_path=components/css/shop_translator.css
...
append_js $sc_web_path/templates/components.html $shop_translator_js_path
append_css $sc_web_path/templates/components.html $shop_translator_css_path