module.exports = function(grunt) {
    ...
    var secondarySpecialScholsDirPath = 'components/secondary_special_schools_ui/';
    ...
    grunt.initConfig({
        concat: {
            ...
            secondarySpecialSchoolsSection: {
                src: [secondarySpecialScholsDirPath + 'src/secondary-special-schools-common.js',
                    secondarySpecialScholsDirPath + 'src/secondary-special-schools-component.js',
                    secondarySpecialScholsDirPath + 'src/secondary-special-schools-paintPanel.js'
                ],
                dest: secondarySpecialScholsDirPath + 'static/components/js/secondary_special_schools_ui/secondary-special-schools.js'
            },
        },
        copy: {
            githubJs: {
            ...
            secondarySpecialSchoolsJs: {
                cwd: secondarySpecialScholsDirPath + 'static/components/js/secondary_special_schools_ui/',
                src: 'secondary-special-schools.js',
                dest: clientJsDirPath + 'secondary_special_schools_ui/',
                expand: true,
                flatten: true
            },
            githubCss: {
        ...
        watch: {
            ...
            secondarySpecialSchoolsJs: {
                files: secondarySpecialScholsDirPath + 'src/**',
                tasks: ['concat:secondarySpecialSchoolsSection', 'copy:secondarySpecialSchoolsJs'],
            },
            githubCss: {
