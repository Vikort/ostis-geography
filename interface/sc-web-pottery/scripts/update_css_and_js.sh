...
pottery_js_path=components/js/pottery/pottery.js
pottery_css_path=components/css/pottery.css
...
append_js $sc_web_path/templates/components.html $pottery_js_path
append_css $sc_web_path/templates/components.html $pottery_css_path
