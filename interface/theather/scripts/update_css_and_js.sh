...
theater_js_path=components/js/theater/theater.js
theater_css_path=components/css/theater.css
...
append_js $sc_web_path/templates/components.html $theater_js_path
append_css $sc_web_path/templates/components.html $theater_css_path
