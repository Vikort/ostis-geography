module.exports = function(grunt) {
    ...
    var exampleDirPath = 'components/translator/';
    ...
    grunt.initConfig({
        concat: {
            ...
            example: {
                ...
                dest: exampleDirPath + 'static/components/js/translator/example.js'
            },
        },
        copy: {
            githubJs: {
            ...
            exampleJs: {
                cwd: exampleDirPath + 'static/components/js/translator/',
                src: 'example.js',
