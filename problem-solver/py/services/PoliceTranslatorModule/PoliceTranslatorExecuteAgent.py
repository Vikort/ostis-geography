...
class PoliceTranslatorExecuteAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
            ...
            try:
                ...
                print("started...")
                ruNameNode = self.get_action_argument(self.main_node, 'rrel_1')
                ...
                os.system(f" java -jar ../../../../tools/police_parser/PoliceTranslator.jar Гомель 20")
