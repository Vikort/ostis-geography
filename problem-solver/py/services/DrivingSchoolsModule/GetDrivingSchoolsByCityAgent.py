...
class GetDrivingSchoolsByCityAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
                self.keynodes['action_get_driving_schools_by_city'],
                self.main_node,
            ...
            try:
                ...
                cityIterator = self.ctx.Iterator5(
                    ScType.Unknown,
                    ScType.EdgeAccessConstPosPerm,
                    node,
                    ScType.EdgeAccessConstPosPerm,
                ...
                while cityIterator.Next():
                    for i in range(5):
                         self.add_nodes_to_answer(answerNode, [cityIterator.Get(i)])
