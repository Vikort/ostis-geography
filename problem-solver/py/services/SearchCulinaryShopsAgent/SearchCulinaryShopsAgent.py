    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
            ...
            try:
                ...
                answer = self.module.ctx.HelperResolveSystemIdtf("find_shop_by_status", ScType.NodeConst)
                ...
                while shop.Next():
                    print("sss")
                    find_theater = self.module.ctx.Iterator5(shop.Get(2), ScType.EdgeDCommonConst, city , ScType.EdgeAccessConstPosPerm, nrel_status)
                    print(find_theater)
