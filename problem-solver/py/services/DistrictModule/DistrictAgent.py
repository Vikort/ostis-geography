...
class DistrictAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
                self.keynodes['action_get_district'],
                self.main_node,
            ...
            try:
                ...
                while(definitionIterator.Next()):
                    ...
                    self.add_nodes_to_answer(answerNode, [street,definitionIterator.Get(1), definitionIterator.Get(2)])
