...
class FoundationYearAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
                self.keynodes['action_get_foundation_year'],
                self.main_node,
            ...
            try:
                ...
                definitionIterator = self.ctx.Iterator5(  # находит памятники по типу
                    ScType.Unknown,
                    ScType.EdgeDCommon,
                    node,
                    ScType.EdgeAccessConstPosPerm,
                    self.keynodes['nrel_year_of_foundation']
                )
                ...
                while (definitionIterator.Next()):
                    ...
                    pashaIterator = self.ctx.Iterator3(  # находит всё что есть в городе
                        self.keynodes['concept_coffee_house'],
                        ScType.EdgeAccessConstPosPerm,
                        townElement,
                    )
